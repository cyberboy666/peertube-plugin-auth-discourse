...
function hideDefaultSignin (){
  var loginButton = findNodeByInnerText(document.querySelectorAll('a.peertube-button-link'), 'Login')
  ...
  if( newJoinButton == null ){
    ...
    newJoinButton.setAttribute('href', '/plugins/auth-discourse/0.0.24/auth/discourse-auth') // needs to have the correct version here
